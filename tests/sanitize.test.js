...
describe('Sanitize', () => {
  test('should sanitize a string', () => {
    const toSanitize = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ abcdefghijklmnopqrstuvwxyz àèéìòù 0123456789 ,;:-_*+ !"€£$%&\/\\()=?^[]{}ç°§|<>'
    const expected = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ abcdefghijklmnopqrstuvwxyz a\'e\'e\'i\'o\'u\' 0123456789 ,;:-_*+ !Euro%e\/\\()=?()()  '
